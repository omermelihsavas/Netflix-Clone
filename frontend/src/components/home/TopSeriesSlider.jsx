...
export default function TopSeriesSlider() {
    const [topSeries, setTopSeries] = useState();

    const sliderRef = useRef();

    useEffect(() => {
        fetch(`https://api.themoviedb.org/3/trending/tv/week?api_key=${process.env.REACT_APP_API_KEY}`)
            .then((res) => res.json())
            .then(data => {
    ...
    return (
        <div className='container'>
            <h2 className='movie-header'>Türkiye'de Bugünün Top 10 Dizi Listesi</h2>
            <div className="slider">
                ...
                <Slider {...settings} ref={sliderRef}>
                    <div>
                        <div className='card'>
                            <div>
                                <svg id="rank-1" width="100%" height="100%" viewBox="-20 0 70 154" ><path stroke="#595959" strokeLinejoin="square" strokeWidth="4" d="M35.377 152H72V2.538L2 19.362v30.341l33.377-8.459V152z"></path></svg>
                            </div>
                            <div>
                                <img className='card-image' src={'https://image.tmdb.org/t/p/w500' + topSeries?.sort((a, b) => b.popularity - a.popularity)[0].poster_path} alt={topSeries?.sort((a, b) => b.popularity - a.popularity)[0].poster_path} />
                            </div>
                    ...
                    <div>
                        <div className='card'>
                            <div>
                                <svg id="rank-4" width="100%" height="100%" viewBox="0 0 81 154"><path stroke="#595959" strokeLinejoin="square" strokeWidth="4" d="M72 152h35.333v-30.977H128V92.497h-20.667V2H69.89L2 92.712v28.311h70V152zM36.202 92.188l35.93-47.998v47.998h-35.93z"></path></svg>
                            </div>
                            <div>
                                <img className='card-image' src={'https://image.tmdb.org/t/p/w500' + topSeries?.sort((a, b) => b.popularity - a.popularity)[3].poster_path} alt={topSeries?.sort((a, b) => b.popularity - a.popularity)[3].poster_path} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='card'>
                            <div>
                                <svg id="rank-7" viewBox="0 0 78 154" width="100%" height="100%"><path stroke="#595959" strokeWidth="4" d="M113,2 L2,2 L2,33.4022989 L75.9665929,33.4022989 L21.22571,152 L60.28102,152 L113,32.7672283 L113,2 Z" strokeLinejoin="square"></path></svg>
                            </div>
                            <div>
                                <img className='card-image' src={'https://image.tmdb.org/t/p/w500' + topSeries?.sort((a, b) => b.popularity - a.popularity)[6].poster_path} alt={topSeries?.sort((a, b) => b.popularity - a.popularity)[6].poster_path} />
                            </div>
                        </div>
                    </div>
