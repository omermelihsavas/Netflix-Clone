    ...
    return (
        <div className='header'>
            ...
            <div className="right-side">
                <FontAwesomeIcon className='search-icon' icon={faMagnifyingGlass} size="2xl" transform={{ rotate: 340 }} style={{ color: "#ffffff" }} />
