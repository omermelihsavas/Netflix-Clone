...
export default function TopFilmSlider() {
    ...
    return (
        <div className='container'>
            <h2 className='movie-header'>Türkiye'de Bugünün Top 10 Film Listesi</h2>
                ...
                <Slider {...settings} ref={sliderRef}>
                    <div>
                        <div className='card'>
                            ...
                            <div>
                                <img className='card-image' src={'https://image.tmdb.org/t/p/w500' + topMovies?.sort((a, b) => b.popularity - a.popularity)[0].poster_path} alt={topMovies?.sort((a, b) => b.popularity - a.popularity)[0].poster_path} />
                            </div>
                    ...
                    <div>
                        <div className='card'>
                            ...
                            <div>
                                <img className='card-image' src={'https://image.tmdb.org/t/p/w500' + topMovies?.sort((a, b) => b.popularity - a.popularity)[1].poster_path} alt={topMovies?.sort((a, b) => b.popularity - a.popularity)[1].poster_path} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='card'>
                            ...
                            <div>
                                <img className='card-image' src={'https://image.tmdb.org/t/p/w500' + topMovies?.sort((a, b) => b.popularity - a.popularity)[2].poster_path} alt={topMovies?.sort((a, b) => b.popularity - a.popularity)[2].poster_path} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='card'>
                            ...
                            <div>
                                <img className='card-image' src={'https://image.tmdb.org/t/p/w500' + topMovies?.sort((a, b) => b.popularity - a.popularity)[3].poster_path} alt={topMovies?.sort((a, b) => b.popularity - a.popularity)[3].poster_path} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='card'>
                            ...
                            <div>
                                <img className='card-image' src={'https://image.tmdb.org/t/p/w500' + topMovies?.sort((a, b) => b.popularity - a.popularity)[4].poster_path} alt={topMovies?.sort((a, b) => b.popularity - a.popularity)[4].poster_path} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='card'>
                            ...
                            <div>
                                <img className='card-image' src={'https://image.tmdb.org/t/p/w500' + topMovies?.sort((a, b) => b.popularity - a.popularity)[5].poster_path} alt={topMovies?.sort((a, b) => b.popularity - a.popularity)[5].poster_path} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='card'>
                            ...
                            <div>
                                <img className='card-image' src={'https://image.tmdb.org/t/p/w500' + topMovies?.sort((a, b) => b.popularity - a.popularity)[6].poster_path} alt={topMovies?.sort((a, b) => b.popularity - a.popularity)[6].poster_path} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='card'>
                            ...
                            <div>
                                <img className='card-image' src={'https://image.tmdb.org/t/p/w500' + topMovies?.sort((a, b) => b.popularity - a.popularity)[7].poster_path} alt={topMovies?.sort((a, b) => b.popularity - a.popularity)[7].poster_path} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='card'>
                            ...
                            <div>
                                <img className='card-image' src={'https://image.tmdb.org/t/p/w500' + topMovies?.sort((a, b) => b.popularity - a.popularity)[8].poster_path} alt={topMovies?.sort((a, b) => b.popularity - a.popularity)[8].poster_path} />
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <div className='card'>
                            ...
                            <div>
                                <img className='card-image' src={'https://image.tmdb.org/t/p/w500' + topMovies?.sort((a, b) => b.popularity - a.popularity)[9].poster_path} alt={topMovies?.sort((a, b) => b.popularity - a.popularity)[9].poster_path} />
                            </div>
                        </div>
                    </div>
                </Slider>
